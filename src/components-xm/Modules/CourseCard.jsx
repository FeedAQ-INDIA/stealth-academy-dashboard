import {ChevronLeft, ChevronRight, Clock, ExternalLink, GraduationCap, Lock, LogOut, Search,} from "lucide-react";
    ...
    return (
        <Card className="group relative overflow-hidden border-0 shadow-lg hover:shadow-2xl transition-all duration-300 bg-gradient-to-br from-white to-yellow-50/50 hover:from-white hover:to-yellow-700/30 hover:-translate-y-1 cursor-pointer">
            ...
            <CardHeader className="pb-2 relative z-10">
                ...
                <div>
                    <CardTitle className="text-md sm:text-lg font-semibold line-clamp-2 hover:text-blue-900 transition-all duration-300">
                        {a?.courseTitle?.toUpperCase()}
                    </CardTitle>
                </div>
            </CardHeader>

            <CardFooter className="flex w-full flex-wrap gap-3 items-center pt-3 border-t border-gray-100 relative z-10">
