...
function SignInPage() {
    ...
    return (
        <div
            className="min-h-screen w-full flex items-center justify-center bg-cover bg-center px-4  bg-gradient-to-r from-purple-600 via-blue-600 to-indigo-700  rounded-2xl "
        >
