    ...
    <>
      ...
      <div className="space-y-6 p-4">
        <div className="relative overflow-hidden">
          <Card className="w-full rounded-lg border-0 bg-gradient-to-r from-orange-400 via-orange-600 to-orange-800  rounded-2xl text-white shadow-2xl backdrop-blur-sm">
