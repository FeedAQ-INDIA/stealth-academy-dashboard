...
function RegisterAsOrg() {
    ...
    const registrationSchema = z.object({
        ...
        adminName: z.string().min(2, "Admin name must be at least 2 characters long"),
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            toast({
                title: "Error",
                description: error.response?.data?.message || "Failed to register organization. Please try again.",
                variant: "destructive",
            });
        } finally {
            setIsLoading(false);
                ...
                <Card className="border-green-200 bg-green-50">
                    <CardContent className="p-6">
                        <div className="flex items-center justify-center space-x-3 text-green-700">
                            ...
                            <div className="text-center">
                                <h3 className="text-lg font-semibold">Organization Registered Successfully!</h3>
                                <p className="text-sm text-green-600 mt-1">
                                    Your organization has been registered. You can now manage members and groups.
                                </p>
                            </div>
                        </div>
                                    ...
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                ...
                                                <FormControl>
                                                    <Input placeholder="admin@organization.com" {...field} />
                                                </FormControl>
                                                <FormMessage />
                                            </FormItem>
                                        )}
