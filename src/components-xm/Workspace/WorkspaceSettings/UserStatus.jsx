...
import UserStatusTable from "@/components-xm/Workspace/WorkspaceSettings/UserStatusTable.jsx";
    ...
    return (
        <>
            <header className="flex h-12 shrink-0 items-center gap-2 border-b px-4">
                ...
                <Breadcrumb>
                    <BreadcrumbList>
                        ...
                        <BreadcrumbItem>
                            <BreadcrumbPage>User Status</BreadcrumbPage>
                        </BreadcrumbItem>
                    </BreadcrumbList>
                </Breadcrumb>
            ...
            <CardHeader className="flex md:flex-row sm:flex-col gap-4 items-center bg-muted/50">
                ...
                <div className="ml-auto sm:flex-initial">
                    <Link to={`/workspace/${WorkspaceId}/settings/user-status-setup/create`}>
                        <Button size="sm">Create User Status</Button>
                    </Link>
                </div>
            </CardHeader>
