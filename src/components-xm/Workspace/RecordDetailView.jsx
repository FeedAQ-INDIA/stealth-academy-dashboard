                ...
                <Separator orientation="vertical" className="mr-2 h-4"/>
                 ...
                 <Breadcrumb>
                    <BreadcrumbList>
                        ...
                        <BreadcrumbItem className="hidden md:block">
                            <Link to={`/workspace/${WorkspaceId}/record?tab=record`} className="breadcrumb-link">
                                Views
                            </Link>
                        </BreadcrumbItem>
                        <BreadcrumbSeparator className="hidden md:block"/>
                        <BreadcrumbItem>
                            <BreadcrumbPage>Record Detail</BreadcrumbPage>
                        </BreadcrumbItem>
                    </BreadcrumbList>
                </Breadcrumb>
                        ...
                        <div className="mt-4 flex flex-col gap-2">
                            {recordList?.map(a => (
                                <Card className={`hover:shadow-md ${RecordId == a.recordId ? 'border-2 border-blue-800  shadow-md' : ''}`}
                                      onClick={()=>navigate(`/workspace/${WorkspaceId}/record/${a.recordId}?tab=record&limit=${limit}&offset=${offset}`)}>
