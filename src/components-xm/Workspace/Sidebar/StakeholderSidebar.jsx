...
function StakeholderSidebar({workspaceDetail}) {
    ...
    useEffect(() => {
        if (location.pathname.includes("/settings")) setUrlEndpoint('/settings/'); else if (location.pathname.includes("/stakeholder")) setUrlEndpoint('/stakeholder/'); else setUrlEndpoint('/default/');
    }, [location.pathname]);
