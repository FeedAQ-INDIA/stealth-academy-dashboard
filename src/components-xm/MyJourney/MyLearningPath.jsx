    ...
    axiosConn
      ...
      .then((res) => {
        ...
        const stats = {
          ...
          totalHours: courses.reduce((total, course) => total + (course.courseDuration || 0), 0) / 60,
        };
          ...
          <Card className="mb-6 border-l-4 border-l-yellow-500 bg-gradient-to-r from-yellow-50 to-orange-50">
            <CardContent className="p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-gray-800">Great Progress! 🎉</h3>
                  <p className="text-sm text-gray-600">
                    You've completed {learningStats.completedCourses} course{learningStats.completedCourses !== 1 ? 's' : ''}. 
